...
<div class="nav_bar">
    ...
    <div id="menu">
        <ul>
          <li id="categories0"><a href="#">ABOUT US</a> </li>
                              <li id="categories1"><a href="#">MAKE A PAY</a>
                
            </li>
                </li>
                       <li id="categories1"><a href="#">UNREGISTER</a>
            ...
            <li id="categories">
                ...
                <ul>
                    ...
                    <li id="da">
                        <a href="request.php" target="_blank">E-CARD</a>
                        <ul>
                            <li><a href="request.php" target="_blank">STUDENT</a></li>
                            <li><a href="#">MEAL</a></li>
                        </ul>
                    </li>
